...
Solutions pour HC13T1 → HC13T10. Chaque tâche inclut le code Haskell demandé et un `main` de test indépendant.
...
main = do 
    ...
    putStrLn $ "Répertoire courant: " ++ currentDir
    
    -- Lister tous les fichiers/dossiers
    contents <- listDirectory "."
    putStrLn "Contenu du répertoire courant:"
